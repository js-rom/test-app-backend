...
@Log4j2
@Service
// @Profile("dev") // comented: apply to all profiles (pro, dev, test) not
// comented: apply only to dev
public class DatabaseSeederDev {
    ...
    private void seedDataBaseJava() {
        ...
        SingleSelectionQuestion[] questionsModel = {
        ...
        Questionaire questionaireModel = Questionaire.builder()
                .description("Cuestionario 3")
                .singleSelectionQuestion(questionsModel[0])
                .singleSelectionQuestion(questionsModel[1]).build();

        QuestionaireEntity questionaireEntity = new QuestionaireEntity(questionaireModel);
